...
export const create = async (client, paymentData) => {
    const { user_id, amount, currency, payment_method, transaction_id, status } = paymentData;
    ...
    const values = [user_id, amount, currency, payment_method, transaction_id, status];
