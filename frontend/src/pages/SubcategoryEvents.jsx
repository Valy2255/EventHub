      ...
      try {
        ...
        if (eventsResponse.data) {
          if (Array.isArray(eventsResponse.data.events)) {
            ...
            const isAllEventsLoaded = checkIfAllEventsLoaded(
              events,
              eventsPerPage
            );
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">
            The subcategory you're looking for doesn't exist or has been
            removed.
          </p>
          <Link
            to="/"
        ...
        {displayedEvents.length === 0 ? (
          <div className="text-center py-12">
            <h2 className="text-xl font-semibold mb-2">
              No events available in this subcategory
            </h2>
            <p className="text-gray-500">
              Check back later for updates or try another subcategory.
            </p>
          </div>
        ) : (
          <div className="space-y-4">
                        ...
                        event.original_date && (
                          <div className="text-xs text-gray-500 mb-1">
                            <span className="line-through">
                              Originally:{" "}
                              {new Date(event.original_date).toLocaleDateString(
                                "en-US",
                                {
                                  month: "short",
                                  day: "numeric",
