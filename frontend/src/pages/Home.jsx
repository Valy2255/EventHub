...
// Date simulate pentru evenimente
const dummyEvents = [
  {
    id: 1,
    name: 'Concert Untold 2025',
    date: '2025-08-01',
    venue: 'Cluj Arena',
    city: 'Cluj-Napoca',
...
const categories = ['Toate', 'Concerte', 'Teatru', 'Sport', 'Festivaluri', 'Conferințe'];
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      >
        <div className="container mx-auto text-center relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">Descoperă cele mai tari evenimente</h1>
          <p className="text-xl mb-8 max-w-2xl mx-auto text-gray-200">
            Achiziționează bilete rapid și sigur pentru concerte, festivaluri, spectacole și multe altele
          </p>
          <Link 
            to="/events" 
